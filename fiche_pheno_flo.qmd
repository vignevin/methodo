...
-   Le pourcentage de floraison pour chaque organe ou cep observé **OPEN_FLO_PC** (CO_356:1000181) est la donnée de base. La correspondance avec le stade BBCH se fait avec le chiffre des dizaines : 10% de floraison correspond au stade BBCH61, 20% au stade BBCH62 etc.

-   La date de mi-floraison **FLO_50** (CO_356:1000011) est la date calendaire où le seuil de 50% des fleurs ouvertes est atteint . Elle est calculée par interpolation entre les valeurs observées avant et après 50% des effectifs observés ayant atteint le stade floraison.
...
-   La date de début floraison **FLO_START** (CO_356:1000083) est la date calendaire où les premières fleurs ouvertes sont observées (BBCH61).

-   Pour les comparaisons inter-annuelles, la date de mi-floraison calendaire peut être exprimée en nombre de jours depuis le début de l'année **DOY_FLO** (CO_356:1000077). Par exemple, le 16 juin 2024 est le jour 168 de l'année.
