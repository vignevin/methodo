...
L'*IAC* a été mis au point pour le déclenchement de l'irrigation, il sera plus discriminant en début de saison, alors que la variation de l'*iC~Apex~* est plus linéaire.
