...
C'est la date calendaire où le seuil de 50% de bourgeons débourrés par rapport au nombre d'yeux francs laissés à la taille est atteint ([BUD_DATE](https://cropontology.org/term/CO_356:1000001)).

## Interprétation des résultats

Pour les comparaisons inter-annuelles, la date de débourrement calendaire peut être exprimée en nombre de jours depuis le début de l'année ([DOY_BUD](https://cropontology.org/term/CO_356:1000076)).

Par exemple, le 28 mars 2024 est le jour 88 de l'année.
